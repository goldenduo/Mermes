 ...
 * Based on Termux WcWidth.java (Unicode 15, table-driven with binary search).
 */
object WcWidth {
     ...
     * Returns 0 for zero-width characters (combining marks, etc.)
     * Returns 0 for control characters (Termux convention).
     */
    ...
    // ZERO_WIDTH table from Termux (Unicode 15)
